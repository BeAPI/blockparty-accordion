...
PHP_FILE="blockparty-accordion.php"
...
sed -i '' "s/define( 'BLOCKPARTY_ACCORDION_VERSION', '[0-9]*\.[0-9]*\.[0-9]*' )/define( 'BLOCKPARTY_ACCORDION_VERSION', '${VERSION}' )/" "${ROOT_DIR}/${PHP_FILE}"
